...
typedef struct
{
  Elf64_Word buckets;  // Number of hash buckets
  Elf64_Word symndx;   //Index first symbol (on symtab)
  Elf64_Word maskwords;//Number of maskwords shift2
  Elf64_Word shift2;   //Shift for bloomfilter
} Elf64_Hash;

typedef Elf64_Word  Elf64_mask32;
typedef Elf64_Xword Elf64_mask64;
typedef Elf64_Word  Elf64_bucket;
